 ...
 $scope.goToForum = function(){
		...
		services.getLogForumStatus($scope.userData.username,$scope.userData.email)
			.then(function (result) {
				...
				console.log("1.is_forum_registered",result);
				console.log("1.$scope.userData.usergroup",$scope.userData.usergroup);

				if (result == true  || $scope.userData.usergroup == "1"){ //if registered in Forum or interessent -> go to Forum
  			...
  			.then(function (result) {
				  ...
				  if (typeof(result) == "object") {
						...
						console.dir(result);	  
						 ...
						 console.log("1.$scope.userData",$scope.userData);
						...
						if ($scope.userData.usergroup != "9" && (timestamp_pp_accepted < pp_timestamp) ){
							...
							if ($scope.userData.usergroup == "1" && $scope.userData.questions_answered == "0" ) {
								...
								else if (localStorage.goToForum == "true"){ //if we come from support forum page 
   ...
   if ($scope.$parent.userLogged) {
		...
		if ($scope.userData.usergroup != "9" && (timestamp_pp_accepted < pp_timestamp) ){
			...
			if ($scope.userData.usergroup == "1" && $scope.userData.questions_answered == "0" ) {
				...
				if (localStorage.goToForum == "true"){ //if we come from support forum page 
